...
<>
    ...
    <ImageBackground
      ...
      <View style={[styles.container,{backgroundColor: theme.screenBackgroud}]}>
        ...
        <Text style={styles.subHeaderText}>{t('browser_in_btx_crypto_wallet')}</Text>
